 ...
 * @description Thành phần hiển thị và chọn ảnh đại diện (Avatar).
 * @param {Object} props
...
const AvatarUploader = ({ 
  ...
  return (
    <div className="flex flex-col md:flex-row items-center gap-8 bg-slate-50/50 p-8 rounded-[2rem] border border-slate-100 shadow-inner">
      {/* Container hiển thị ảnh đại diện */}
      ...
      <div className="text-center md:text-left space-y-2">
        <h4 className="text-sm font-black text-slate-800 uppercase tracking-wider">Profile Photo</h4>
        <p className="text-[11px] text-slate-400 font-bold leading-relaxed max-w-xs italic">
          Click the camera icon to select a new image. 
          <br />
          Recommended: JPG, PNG under 2MB.
        </p>
        
        {/* Hiển thị badge nếu đã chọn file mới chưa lưu */}
        {selectedFile && (
