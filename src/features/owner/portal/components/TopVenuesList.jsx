      ...
      {sortedVenues.map((venue, idx) => {
        ...
        return (
          <motion.div 
            ...
            className="group flex items-center p-6 bg-white rounded-[2rem] border-2 border-slate-100 shadow-sm hover:shadow-xl hover:border-violet-200 hover:bg-violet-50/20 transition-all duration-300 cursor-pointer relative overflow-hidden"
          >
