 ...
 * @description Hiển thị danh sách các món ăn tiêu biểu của nhà hàng (Giới hạn 4 món).
 *              Click vào món để xem popup chi tiết đầy đủ.
 */
const RestaurantMenuPreview = ({ menuItems, onViewFullMenu }) => {
  const [selectedItem, setSelectedItem] = useState(null);

  // Chỉ lấy tối đa 4 món tiêu biểu để làm Preview
    ...
    <div className="space-y-10">
      <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div className="space-y-2">
          <h2 className="text-3xl font-bold tracking-tight text-on-surface">Signature Offerings</h2>
